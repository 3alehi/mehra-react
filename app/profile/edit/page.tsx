...
const Page: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="border max-md:rounded-none rounded-2xl w-full flex-col flex items-center justify-center py-20">
            ...
            <div className="mt-4 w-full flex justify-end">
              <Button
                ...
                disabled={
                  ...
                  !!formState.emailError || // تبدیل به boolean
                  !!formState.passwordError || // تبدیل به boolean
                  (!!formState.password && !formState.password1) // اطمینان از boolean
                }
