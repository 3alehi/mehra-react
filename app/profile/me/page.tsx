...
const Page: React.FC = () => {
 ...
 `}
      ...
      <div className='border ronded-2xl w-full px-5 max-md:px-4 py-6 rounded-2xl bg-lightBlueGray border-lightGrayBlue2 grid grid-cols-3 gap-7'>
      {isLoading && (
    <>
        {[...Array(3)].map((_, index) => (
            <div
      ...
      <div className='border ronded-2xl w-full px-5 py-6 rounded-2xl bg-lightBlueGray border-lightGrayBlue2 grid grid-flow-col gap-7 max-md:gap-3'>
