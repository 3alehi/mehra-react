    ...
    return (
        <div className='px-14 max-md:px-4'>
            <div className='mt-8 flex items-center w-[60%] justify-between'>
                ...
                <p className='text-darkGray text-2xl max-md:text-base '>کد تایید</p>
            </div>
            <p className='mt-9 text-aquaBlue text-lg max-md:text-sm'>کد تایید برای شماره {phoneNumber} پیامک شد</p>
            <p className='text-lg text-darkGray mt-7 max-md:text-sm'>کد تایید را وارد کنید</p>
                ...
                <div className="space-y-2">
                    ...
                    >
                        <InputOTPGroup className='flex gap-4'>
                            <InputOTPSlot className='rounded-lg border border-vibrantOrange' index={5} />
                            <InputOTPSlot className='rounded-lg border border-vibrantOrange' index={4} />
