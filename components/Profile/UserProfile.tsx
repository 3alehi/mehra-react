...
const UserProfile: React.FC = () => {
    ...
    <div className="relative">
            ...
            <div className='mr-6'>
             ...
             <div className='flex'>
             <p className="flex items-center mt-2 text-darkGray text-sm">
          <span className="mr-2"> {followersCount == undefined ? 0 : followersCount} دنبال کننده </span>
            </p>
            
            <p className="flex items-center mt-2 text-darkGray text-sm">
           <span className="mr-2"> {followingCount == undefined ? 0 : followingCount} دنبال شده </span>
            </p>
             </div>
            </div>
    </div>
